...
class Structdata:
    ...
    def __init__(self, data, fig_size=(5,5), save_fig=False):
        self.data = data
    ...
    def bar_cat_features(self, data=None, cat_features=None, separate_by=None, fig_size=(5,5), save_fig=False):
        '''
    ...
    def box_num_2_cat_target(self, data=None, num_features=None, target=None, fig_size=(5,5), large_data=False, save_fig=False):
        '''
    ...
    def violin_num_2_cat_target(self, data=None, num_features=None, target=None, fig_size=(5,5), save_fig=False):
        '''
    ...
    def hist_num_features(self, data=None, num_features=None, bins=None, show_dist_type=False, fig_size=(5,5), save_fig=False):
        '''
    ...
    def bar_cat_2_cat_target(self, data=None, cat_features=None, target=None, fig_size=(12,6), save_fig=False):
        '''
    ...
    def class_in_cat_feature(self, data=None, cat_features=None, plot=False, save_fig=False):
        '''
    ...
    def scatter_num_2_num_feat(self, data=None, num_features=None, target=None, separate_by=None, fig_size=(10,10), save_fig=False):
        '''
        Makes an histogram plot of all numerical featureures. Helps to show the distribution of the featureures.
